...
import application.moteur.comptebancaire.CompteBancaire;
import application.moteur.personne.PharmacienManager;
import application.moteur.pharmacie.Pharmacie;
...
import application.moteur.anciennete.*;
import application.moteur.cartebancaire.*;
import application.moteur.comptebancaire.*;
import application.moteur.pays.*;
import application.moteur.personne.*;
import application.moteur.pharmacie.*;
import application.moteur.produit.*;
import application.moteur.reseaubancaire.*;
import application.moteur.*;
